...
#source_dhis2_username = os.getenv('SOURCE_DHIS2_USERNAME', '')
#source_dhis2_password = os.getenv('SOURCE_DHIS2_PASSWORD', '')
#target_dhis2_username = os.getenv('TARGET_DHIS2_USERNAME', 'admin')
#target_dhis2_password = os.getenv('TARGET_DHIS2_PASSWORD', 'district')

# Parameters for data push
org_unit_id = 'ncgkwcQrfmc' #'ncgkwcQrfmc' Replace with your actual org unit ID - This is Kanyama First Level in MORE-ZM
...
# Function to load mappings from Excel filecls
