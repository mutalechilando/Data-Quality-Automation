...
data_element_mapping = load_mappings('mappings.xlsx', sheet_name='HIA2 to MORE-ZM - categories', source_col='morezm_dataid', target_col='hia2_dataid')
category_option_combo_mapping = load_mappings('mappings.xlsx', sheet_name='HIA2 to MORE-ZM - categories', source_col='morezm_categoryoptioncomboid', target_col='hia2_categoryoptioncomboid')
org_unit_mapping = load_mappings('mappings.xlsx', sheet_name='org_units', source_col='MORE-ZM', target_col='HIA2')
